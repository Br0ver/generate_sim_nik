...
module post_processing #(    
    ...
    // logic [ACTIVATION_BIT_WIDTH*ACTIVATION_BIT_WIDTH-1:0]                            debug_quantized_activations; 
    ...
    always_comb begin
        for (int i=0; i<ACTIVATION_BIT_WIDTH; i++) begin
            // if(quantized_activations[i][ACTIVATION_BIT_WIDTH-1]==1 || quantized_activations[i]==0) begin // negative value. set to zero.
            //     // relu_activations[i]   = 0; 
            //     // relu_sm[i]            = 0;
            ...
            // end
            // else begin
            //     // relu_activations[i]  = quantized_activations[i];
            //     // relu_sm[i]           = 1;
    ...
    always_ff @(posedge clk) begin
        if (resetn==0) begin
            ...
            // else beginsim:/NVP_v1_top_tb/dut/compute_unit_i/post_processing_unit/debug_scheduled_counter_last_condition
