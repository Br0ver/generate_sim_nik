...
*   Date:  17.11.2021
*   Author: hasan
*   Description: The PE array consists of an arbiter and a number of PE groups. Each PE group consists of a number of PEs. 
*           A number of channels are assigned to each PE group, where the internal PEs share the workload. 
*/
